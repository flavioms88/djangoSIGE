...
urlpatterns = [
    ...
    # Prospects
    # cadastro/outros/adicionar/
    url(r'outros/adicionarprospect/$',
        views.AdicionarProspectView.as_view(), name='addprospectview'),
    # cadastro/outros/listaprospects
    url(r'outros/listaprospects/$',
        views.ProspectListView.as_view(), name='listaprospectsview'),
    # cadastro/outros/editarprospect/
    url(r'outros/editarprospect/(?P<pk>[0-9]+)/$',
